...
Once the proposal is approved by the Community Council, the Tip amount is sent to the Agent’s wallet address.
...
|GOV|Governance & Project Engagement<br> As per General Agent. | As per General Agent.|
