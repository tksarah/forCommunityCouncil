...
|SM|Social Media Engagement<br>As per General Agent.|As per General Agent.|
|CM|Community Management<br>As per General Agent, Independently launch a community focused on relevant technologies (e.g., WASM, blockchain nodes) and provide leadership and support within it.|As per General Agent.|
|CC|Content Creation<br>As per General Agent.|As per General Agent.|
|EM|Event Management<br>As per General Agent.|As per General Agent.|
|BD|Business Development<br>As per General Agent.|As per General Agent.|
